...
var _exportNames = {
  ...
  ConnectState: true,
  GatewayType: true,
  GatewayIpSettingType: true,
  LockSoundVolume: true
};
exports.Ttlock = exports.TtGateway = exports.LockState = exports.LockSoundVolume = exports.LockRecordType = exports.LockPassageMode = exports.LockFunction = exports.LockControlType = exports.LockConfigType = exports.GatewayType = exports.GatewayIpSettingType = exports.ConnectState = exports.BluetoothState = void 0;
...
class Ttlock {
  ...
  static addRemoteDevice(remoteDeviceMac, cycleDateList, startDate, endDate, lockData, success, fail) {
    success = success || this.defaultCallback;
    fail = fail || this.defaultCallback;
  ...
  static modifyRemoteDevice(remoteDeviceMac, cycleDateList, startDate, endDate, lockData, success, fail) {
    success = success || this.defaultCallback;
    fail = fail || this.defaultCallback;
    ttlockModule.modifyRemoteDevice(remoteDeviceMac, cycleDateList, startDate, endDate, lockData, success, fail);
  }
  static deleteRemoteDevice(remoteDeviceMac, lockData, success, fail) {
    success = success || this.defaultCallback;
    fail = fail || this.defaultCallback;
    ttlockModule.deleteRemoteDevice(remoteDeviceMac, lockData, success, fail);
  }
  static clearAllRemoteDevice(lockData, success, fail) {
    success = success || this.defaultCallback;
    fail = fail || this.defaultCallback;
...
(function (LockFunction) {
  ...
  LockFunction[LockFunction["WirelessKeyFob"] = 41] = "WirelessKeyFob";
...
(function (UnlockDirection) {
  UnlockDirection[UnlockDirection["Left"] = 1] = "Left";
  UnlockDirection[UnlockDirection["Right"] = 2] = "Right";
