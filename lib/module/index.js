...
class TtRemoteKey {
  ...
  static init(mac, lockData, success, fail) {
    ...
    ttlockModule.initRemoteKey(mac, lockData, success, errorCode => {
  ...
  static getSystemInfo(mac, success, fail) {
    success = success || this.defaultCallback;
    fail = fail || this.defaultCallback;
...
(function (LockFunction) {
  ...
  LockFunction[LockFunction["RemoteKeypad"] = 24] = "RemoteKeypad";
...
})(TtRemoteKeyEvent || (TtRemoteKeyEvent = {}));
var GatewayEvent;
...
})(LockAccessoryType || (LockAccessoryType = {}));
...
})(GatewayIpSettingType || (GatewayIpSettingType = {}));
export { Ttlock, TtGateway, TtRemoteKey, BluetoothState, LockFunction, LockRecordType, LockConfigType, LockPassageMode, LockControlType, LockState, ConnectState, GatewayType, GatewayIpSettingType, LockSoundVolume, TtRemoteKeyEvent, LockUnlockDirection, LockAccessoryType };
